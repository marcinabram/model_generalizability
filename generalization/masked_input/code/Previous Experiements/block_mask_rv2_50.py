...
def main():
    ...
    model_name="Block Masking Rv2-50 cifar100"
    ...
    #Makes it a bit easier to restart training
        ...
        Model=tf.keras.applications.resnet_v2.ResNet50V2(include_top=True,input_shape= (image_size, image_size, 3),weights=None, classes=100)
...
def mask_data(image_size,data,Model):
    ...
    for i, j in enumerate(max_index):
        ...
        mask[i, trunkate(row-pixel_mask):row+pixel_mask+1, trunkate(column-pixel_mask):column+pixel_mask+1, :] = 0
